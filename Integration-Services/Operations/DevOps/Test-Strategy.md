...
![testpyramid](/Integration-Services/.attachments/test-pyramid.png)
...
![testshiftleft](/Integration-Services/.attachments/test-shift-left.png)
...
![testmanualrun](/Integration-Services/.attachments/test-manual-run.png)
...
![testmanualparams](/Integration-Services/.attachments/test-manual-params.png)
...
![testbuildvalsetup](/Integration-Services/.attachments/test-build-validationsetup.png)

#### Validation Results

Results are displayed on each Pull request showing whether the tests passed or failed.

![testbuildvalresult](/Integration-Services/.attachments/test-build-validation-result.png)
...
![testcc](/Integration-Services/.attachments/test-build-validationsetup.png)
